...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubSubheading
      {\hspace{8pt}Engineering Leadership \& Enablement}
      \resumeItemListStart
    ...
    \resumeSubSubheading
      {\hspace{8pt}Service Reliability \& Operational Efficiency}
      \resumeItemListStart
  ...
  \resumeSubHeadingListStart
    ...
    \end{tabular*}
      \vspace{0pt}
      \resumeSubSubheading
        {\hspace{8pt}CV Detection Services \& Per-Video-Channel Performance Monitoring}
        \resumeItemListStart
      ...
      \vspace{4pt}
      \resumeSubSubheading
        {\hspace{8pt}Human-in-the-Loop Service for Boosting Detection Accuracy}
        \resumeItemListStart
