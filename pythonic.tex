...
\section{Summary}
  \begin{itemize}[leftmargin=16pt]
    \item\small{{Long-time leader in the Taiwanese Python community---translation lead for Python's official documentation, former PyCon Taiwan dev lead, and contributor across the Python ecosystem\vspace{-8pt}}}
    \item\small{{Senior Python backend engineer with 8+ years in production---net-new services, multi-tenant SaaS, and infrastructure modernization across logistics, fintech, and computer vision\vspace{-8pt}}}
    \item\small{{Architect-mode work spanning system design, platform standards, and operational ownership---current focus on platform engineering and reliability\vspace{-8pt}}}
    \resumeItemListEnd
  ...
  \section{Open Source \& Community Experience}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        ...
        \resumeItem{Featured on PyCast (PyCon TW's podcast channel) discussing \href{https://pycast.firstory.io/episodes/cluul59f808uc01vv7r6jhtn3}{junior-to-senior engineering growth}, and interviewed Sebasti\'an Ram\'irez (creator of FastAPI) for an upcoming episode.}
      \resumeItemListEnd
