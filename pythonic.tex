    ...
    \end{tabular*}
      ...
      \resumeSubSubheading
        ...
        \resumeItemListStart
          ...
          \resumeItem{Built auditing process with affiliated Grafana dashboards to examine detection accuracy of each production pipeline without straining human resources. Enabled faster response from engineers to any performance deterioration.}
        \resumeItemListEnd
...
\section{Technical Skills}
  ...
  \section{Community Experience}  
    ...
    \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        \resumeItem{Held weekly meetups focusing on the convolutional neural networks (CNN) papers in computer vision domain \& the model implementation in PyTorch.}
      \resumeItemListEnd
    \resumeSubHeadingListEnd
