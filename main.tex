...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeSubSubheading
        ...
        \resumeItemListStart
          ...
          \resumeItem{Reduced average requesting latency by 30\% through optmizing MongoDB usage, such as rectifying indexes to accommodate usage pattern, refining queries for index-covered query plans, \& adopting read-write separation.}
          \resumeItem{Built auditing process \& affiliated Grafana dashboards for examining detection accuracy of each pipeline by leveraging excessive human resource. Enabled faster response from engineers to any performance deterioration.}
        \resumeItemListEnd
      ...
      \resumeSubSubheading
        ...
        \resumeItemListStart
          ...
          \resumeItem{Built cross-services latency tracing dashabords and affiliated alerting by leveraging New Relic Tracing \& Grafana.}
      ...
      \resumeSubSubheading
        ...
        \resumeItemListStart
          ...
          \resumeItem{Integrated AWS Lambda with Slack command used by FAE/Sales to import miss-detected events to pipeline.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Implemented a web-based panel for per-camera configuration, which is commonly used across the company.}
  ...
  \section{Community Experience}   
    \begin{itemize}[leftmargin=*, label={}]
      ...
      \resumeItemListStart
        ...
        \resumeItem{Built the frontend from ground up with Nuxt.js replacing old Django templates for lower maintenance cost and better support of SEO \& i18n.}
